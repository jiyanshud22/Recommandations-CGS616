...
def recommend(user_id, genres):
    ...
    for rating, movie_id in movies_rating:
        ...
        movie_genre=new_item[new_item['movie id'] == movie_id]['genres'].values[0]
    ...
    return movie_titles,rat,movie_genres  # Return the list of movie titles
...
if st.button('Recommend'):
    recommendations,r,m_g = recommend(selected_user_id, selected_genres)
    for recommendation,r,m_g in zip(recommendations, r,m_g):
